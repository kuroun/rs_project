...
-In order to improve performance of retrieval:
	=> I add index to columns: items_users.user_id, categories_items.category_id, items_users.item_id, items.name
	=> Implement Rails page caching in RecommendationsController 
